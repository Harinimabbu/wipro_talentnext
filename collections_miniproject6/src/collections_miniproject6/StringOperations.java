...
public class StringOperations {
    ...
    public static ArrayList<String> performOperations(String S1, String S2) {
        ...
        // 1. Alternate character replacement with S2
        ...
        // 2. Replace last occurrence of S2 with reverse of S2, if it occurs more than once
        ...
        // 4. Add first half of S2 to start and second half to end
